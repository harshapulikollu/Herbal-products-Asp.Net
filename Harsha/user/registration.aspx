<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="registration.aspx.cs" Inherits="Harsha.user.registration" %>
...
<body>
	...
	<div class="login">
	   ...
	   <asp:TextBox ID="newuserlogin" runat="server"  class="email" placeholder="Username" />
	   <asp:TextBox ID="newpassword" runat="server" TextMode="password" placeholder="Password" />
	   <asp:TextBox ID="cnf_password" runat="server" TextMode="password" placeholder="Confirm Password" />	
	   <ul class="button">
